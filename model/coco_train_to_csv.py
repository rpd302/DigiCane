...
annotation_file = '/scratch/at3577/coco_train/annotations/instances_train2017.json'
image_folder = '/scratch/at3577/coco_train/train2017/'
...
dataframe.to_csv('coco_train_labels.csv', columns=column_name, index=False)
